...
<?php
	...
	if ($_SESSION['rights']==('a'))
	{
		...
		$allnotes = mysqli_query ($link, $query_allnotes) or die(mysqli_connect_error($link));
		...
		$lmnotes = mysqli_query ($link, $query_lmnotes)or die (mysqli_connect_error($link));
		...
		'$end_date'";
		$lmcomments = mysqli_query ($link, $query_lmcomments)or die (mysqli_connect_error($link));
		...
		$lastnote = mysqli_query ($link, $query_last_note) or die (mysqli_connect_error($link));
		...
		$mcnote = mysqli_query($link, $query_mcnote)or die (mysqli_connect_error($link));
